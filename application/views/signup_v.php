...
<p>
        ...
        <br /><input id="user_id" type="text" name="user_id" maxlength="20" value="<?php echo set_value('user_id'); ?>"  />
</p>
...
<p>
        ...
        <br />
                ...
                <input id="gender" name="gender" type="radio" class="" value="option1" <?php echo $this->form_validation->set_radio('gender', 'option1'); ?> />
        		<label for="gender" class="">Male</label>

        		<input id="gender" name="gender" type="radio" class="" value="option2" <?php echo $this->form_validation->set_radio('gender', 'option2'); ?> />
